        ...
        Pass
        {
            ...
            Varyings vert(Attributes input)
            {
                ...
                float animSpeed = _BaseSpeed;
                    ...
                    float3 rotatedNormal = rolledRight * input.normalOS.x + rolledUp * input.normalOS.y + boidDir * input.normalOS.z;
            ...
            {
                // 1. Procedural Color Only (Base Map/Color logic removed)
