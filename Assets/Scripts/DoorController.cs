...
{
    [Header("Door References")] [Tooltip("The child object that contains the actual door mesh/collider.")]
    public Transform doorVisual;

    [Header("Movement Settings")] public Vector3 closedLocalPosition;
    ...
    private void SaveClosedPosition()
    {
    ...
    {
        openLocalPosition = doorVisual.localPosition;
    }
}